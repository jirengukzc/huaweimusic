...
var Swiper = function Swiper(node) {
  ...
  var root = typeof root === 'string' ? document.querySelector(node) : node;
  var eventHub = {
    'swipLeft': [],
    'swipRight': []
  };
...
},{"constants":"node_modules/constants-browserify/constants.json"}],"src/javascript/index.js":[function(require,module,exports) {
"use strict";
